 ...
 * @author HOANG ANH
 */
@WebServlet(name = "Loginstudent", urlPatterns = {"/homestudent"})
public class Loginstudent extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("mail") != null && !request.getParameter("mail").trim().equals("") && request.getParameter("phone") != null
                && !request.getParameter("phone").trim().equals("")) {
            String campus = request.getParameter("campus");
            String mail = request.getParameter("mail");
            String sdt = request.getParameter("phone");
            ControllDao c = new ControllDao();
            String id = c.loginstudent(mail, sdt, campus);System.out.println(id);
            if (id != null) {
                request.getSession().setAttribute("studentid", id);
                response.sendRedirect("homestudent");
            } else {
                mess = "information login incorrect!";
                response.sendRedirect("homestudent");
            }
        } else {
