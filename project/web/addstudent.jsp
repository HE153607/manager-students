...
<html>
    ...
    <body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-10 text-right menu-1">
                                <ul>
                                    ...
                                    <li class="active"><a href="list" style="color: #a7a2a2;">Manager Students List</a></li>
                                    <li class="active"><a href="addstudent">List student</a></li>
        ...
        <form action="addstudent" method="post" name="form-l">
            <% 
            ...
            <div class="pupups" style="width: 200px;height: 100px;background-color: #ccffcc;position: absolute;z-index: 1;
            ...
            <div class="out">
                ...
                <c:if test="<%= a.size()<=0 %>"><p style="font-weight:  bold;text-align:center;">has no student to add</p></c:if>
                ...
                <div class="outin">
                    ...
                    <div class="in4">
                        ...
                        <div style="display:flex;">
                            ...
                            <button name="id" value="<%= a.get(i).getId()%>">Add</button>
        ...
        <script>
            var pup = document.getElementsByClassName("pupups");
            if (pup !== null) {
