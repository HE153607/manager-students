...
<html>
    ...
    <body>
        ...
        <form method="post" action="../admin/addstudent" enctype="multipart/form-data">
            <div class="a">
                <table>
                    <tr>
                        <td>select campus:</td> 
                    ...
                    <tr><td><button value="Upload">Add</button></td><td style="color: red;"><c:if test="${error!=null}">${error}</c:if></td></tr> 
                </table>
            </div>
            <script>
