...
public final class checkdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_c_forEach_0.setItems((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${n.rows}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
      ...
      try {
        ...
        if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            _jspx_th_fmt_formatDate_2.setValue( new Date());
            _jspx_th_fmt_formatDate_2.setPattern("yyyy");
            _jspx_th_fmt_formatDate_2.setVar("end");
      ...
      _jspx_th_c_set_0.setVar("year1");
      _jspx_th_c_set_0.setValue( new Date().getYear() + 1900);
      ...
      _jspx_tagPool_c_set_var_value_nobody.reuse(_jspx_th_c_set_0);
      out.write("\n");
      out.write("        <form action=\"listdate\" method=\"post\" name=\"djk\" id=\"djk\" >\n");
      out.write("            <select onchange=\"sub()\" name=\"year\">\n");
      out.write("                ");
      if (_jspx_meth_c_forEach_1(_jspx_page_context))
        return;
      out.write("\n");
      out.write("            </select>\n");
      out.write("            <select name=\"time\" onchange=\"document.getElementById('djk').submit()\">\n");
      out.write("                ");
      ...
      out.write("               d.name='iden';\n");
      out.write("               d.value='iden';\n");
      out.write("               d.style.display=\"none\";\n");
      out.write("               document.getElementsByTagName('form')[0].appendChild(d);\n");
      out.write("               document.getElementById('djk').submit();\n");
      out.write("            }\n");
      out.write("            //        var x=new XMLHttpRequest();\n");
      out.write("            //        x.open(\"get\",\"listdate\",true);\n");
      out.write("            //        x.send();\n");
      out.write("            //         x.onreadystatechange=function (){\n");
      out.write("            //                if(this.readyState === 4){\n");
      out.write("            //                  document.getElementsByTagName(\"section\")[0].innerHTML=this.responseText;  \n");
      out.write("            //                }\n");
      out.write("            //            }\n");
      out.write("        </script>\n");
      out.write("        </form>\n");
  ...
  private boolean _jspx_meth_sql_setDataSource_0(PageContext _jspx_page_context)
    ...
    _jspx_th_sql_setDataSource_0.setUrl("jdbc:sqlserver://localhost:1433;databaseName=Manager");
    _jspx_th_sql_setDataSource_0.setUser("sa");
    _jspx_th_sql_setDataSource_0.setPassword("anh");
  ...
  private boolean _jspx_meth_sql_query_0(PageContext _jspx_page_context)
    ...
    _jspx_th_sql_query_0.setVar("n");
    _jspx_th_sql_query_0.setSql("select djoin from datejoin where id='HE00001'");
  ...
  private boolean _jspx_meth_fmt_formatDate_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_formatDate_0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${p.djoin}", java.util.Date.class, (PageContext)_jspx_page_context, null));
    _jspx_th_fmt_formatDate_0.setPattern("yyyy");
    _jspx_th_fmt_formatDate_0.setVar("dt");
  ...
  private boolean _jspx_meth_fmt_formatDate_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_fmt_formatDate_1.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${p.djoin}", java.util.Date.class, (PageContext)_jspx_page_context, null));
    _jspx_th_fmt_formatDate_1.setPattern("dd-MM-yyyy");
    _jspx_th_fmt_formatDate_1.setVar("date");
  ...
  private boolean _jspx_meth_c_forEach_1(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_1.setBegin(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${dt}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
    _jspx_th_c_forEach_1.setEnd(((java.lang.Integer) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${end+1}", java.lang.Integer.class, (PageContext)_jspx_page_context, null)).intValue());
  ...
  private boolean _jspx_meth_c_if_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_if_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${year==year1 and requestScope.year==null}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_if_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_if_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${requestScope.year!=null and requestScope.year==year}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_out_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_1, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_1)
    ...
    _jspx_th_c_out_0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${year}", java.lang.Object.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_forEach_2(PageContext _jspx_page_context)
    ...
    _jspx_th_c_forEach_2.setVar("out");
    _jspx_th_c_forEach_2.setVarStatus("count");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                    <option value=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${count.count}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write('"');
          out.write(' ');
  ...
  private boolean _jspx_meth_c_if_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_forEach_2, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_2)
    ...
    _jspx_th_c_if_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${stt!=null and stt==count.count}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
